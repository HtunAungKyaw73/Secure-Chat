...
- [ ] Store active users and current message history in-memory for the MVP.
...
- **Out of Scope**: No persistent database required for MVP (in-memory only). No complex user authentication system beyond a simple username choice. No media uploads.
